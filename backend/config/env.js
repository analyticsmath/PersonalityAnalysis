...
const config = {
  ...
  openaiReportModel: process.env.OPENAI_REPORT_MODEL || process.env.OPENAI_MODEL || 'gpt-5-mini',
  openaiCoachModel: process.env.OPENAI_COACH_MODEL || process.env.OPENAI_MODEL || 'gpt-5-mini',
