  ...
  const resultPayload = {
    ...
    analytics: {
      ...
      aiReport: {
        ...
        generatedAt: now,
        narrativeExtended: narrativeOutput?.narrativeExtended || null,
        aiStatus: narrativeOutput?.aiStatus || null,
        safetyFlags: narrativeOutput?.narrativeExtended?.safetyFlags || [],
      },
    },
