...
export const DevelopmentEchoScene = () => {
  ...
  return (
    <section className="pa-echo-section" aria-labelledby="echo-heading">
      <div className="pa-container">
        <header className="pa-echo-header">
          <h2 id="echo-heading">{developmentEcho.title}</h2>
          <p>{developmentEcho.body}</p>
        </header>
