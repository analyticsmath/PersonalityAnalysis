    ...
    <footer className="pa-px-footer" role="contentinfo">
      <div className="pa-px-footer__inner">
        <div className="pa-px-footer__brand">
          ...
          <p>
            An analytical instrument for reading professional behavior under different conditions. Independent psychometrics with deterministic calibration.
          </p>
        </div>

        <nav className="pa-px-footer__links" aria-label="Footer links">
          <Link to="/">Home</Link>
      ...
      <div className="pa-px-footer__bottom">
        ...
        <span>Sovereign user data rights. No third-party model training.</span>
      </div>
    </footer>
  );
};
