/**
 * Personality Assessor — V4 Public Content & Framework Truth
...
export const PUBLIC_CONTENT = {
  ...
  home: {
    hero: {
      ...
      traceWords: ['context', 'response', 'evidence'],
      descriptor: 'Adaptive personality and career intelligence',
    },
    evidenceSignal: {
      ...
      worlds: [
        {
          ...
          theme: 'Investigative & Conventional',
          imageKey: 'a03',
        ...
        },
        {
          ...
          theme: 'Enterprising & Conventional',
          imageKey: 'a06',
    ...
    trustScene: {
      ...
      stages: [
        ...
        },
        {
          ...
          detail: 'Deterministic psychometric scoring mapped to Big Five, RIASEC, and O*NET frameworks.',
        },
        {
          id: 'separated-models',
          name: 'Separated model outputs',
          detail: 'Dimensions remain distinct calculations rather than an opaque composite score.',
        },
        {
          id: 'controls',
          name: 'Your data controls',
  ...
  howItWorks: {
    ...
    stages: [
      ...
      },
      {
        ...
        evidenceTag: 'Calibrated Inquiries'
      },
      {
        step: '03',
      ...
      },
      {
        ...
        evidenceTag: 'Inspectable Insights'
      },
    ],
    faq: [
      {
