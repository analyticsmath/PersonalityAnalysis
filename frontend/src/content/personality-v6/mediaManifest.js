/**
 * Personality Assessor — V6 Unified Media Manifest
 * Contains validated A-series (A01–A10) and B-series (B01–B12) media definitions
 */

export const MEDIA_ASSETS_V6 = {
  ...
  a05: {
    ...
    photographer: 'Nick Fancher',
    role: 'Social / relational world — facilitation, coaching, alignment',
  ...
  a06: {
    ...
    photographer: 'Nick Fancher',
    role: 'Enterprising / directional world — strategy, leadership, high stakes',
  ...
  a07: {
    ...
    role: 'Methodology: many readings, one person & readings field',
  ...
  a08: {
    ...
    role: 'Trust / handoff fingertip boundary',
  ...
  a09: {
    ...
    photographer: 'Nick Fancher',
    role: 'Login portrait refraction',
  ...
  a10: {
    ...
    photographer: 'Nick Fancher',
    role: 'Signup portrait red landscape',
...
export const getAssetV6 = (id) => MEDIA_ASSETS_V6[id] || null;
